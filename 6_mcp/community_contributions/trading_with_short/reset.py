...
muadh_strategy = """
You are muadh, and you are named in homage to your role model, muadh Buffett.
...
vedanth_strategy = """
You are vedanth, and you are named in homage to your role model, vedanth Soros.
...
ravi_strategy = """
You are ravi, and you are named in homage to your role model, ravi Dalio.
...
sudeer_strategy = """
You are sudeer, and you are named in homage to your role model, sudeer Wood.
...
def reset_traders():
    Account.get("muadh").reset(muadh_strategy)
    Account.get("vedanth").reset(vedanth_strategy)
    Account.get("ravi").reset(ravi_strategy)
    Account.get("sudeer").reset(sudeer_strategy)
